...
ShellBot.InlineKeyboardButton --button 'menu_adm_ser' --line 3 --text '• Menu Xray •' --callback_data '_menuxray'
ShellBot.InlineKeyboardButton --button 'menu_adm_ser' --line 3 --text '🔙 Back 🔙' --callback_data '_mebck'
...
ShellBot.InlineKeyboardButton --button 'menu_re_ser' --line 3 --text '• Xray •' --callback_data '_res_xray_menus'
ShellBot.InlineKeyboardButton --button 'menu_re_ser' --line 3 --text '🔙 Back 🔙' --callback_data 'clses_ser_res'
        ...
        (
            ...
            if [[ ${message_reply_to_message_message_id[$id]} ]]; then
                ...
                '👤 CREATE USER 👤\n\nUsername:')
                    ...
                    [[ "$sizemax" -gt '10' ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "⛔ Use no maximum 10 characters [EX: pompom]")" \
                            --parse_mode html
                        >$CAD_ARQ
                        break
                    }
