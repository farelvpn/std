...
echo ""
wget -q https://raw.githubusercontent.com/Rerechan-Store/std/main/dependencies
...
read answer
    if [ "$answer" == "${answer#[Yy]}" ] ;then
        ...
        wget -q "https://raw.githubusercontent.com/Rerechan-Store/std/main/dll/cf.sh" && chmod +x cf.sh && ./cf.sh
    fi
else
clear
...
wget -q "https://raw.githubusercontent.com/Rerechan-Store/std/main/ssh/ssh-vpn.sh" && chmod +x ssh-vpn.sh && screen -S sshvpn ./ssh-vpn.sh
if [ "$coreselect" = "v2ray" ]; then
wget -q "https://raw.githubusercontent.com/Rerechan-Store/std/main/v2ray/ins-vt.sh" && chmod +x ins-vt.sh && screen -S insvt ./ins-vt.sh
elif [ "$coreselect" = "xray" ]; then
wget -q "https://raw.githubusercontent.com/Rerechan-Store/std/main/xray/ins-xray.sh" && chmod +x ins-xray.sh && screen -S insxray ./ins-xray.sh
fi
wget -q "https://raw.githubusercontent.com/Rerechan-Store/std/main/dll/system/set-br.sh" && chmod +x set-br.sh && screen -S sbr ./set-br.sh
#extension
clear
sleep 1
echo -e "[ ${green}INFO${NC} ] Downloading extension !!"
sleep 1
wget -q -O /usr/bin/xtls "https://raw.githubusercontent.com/Rerechan-Store/std/main/xray/xtls.sh" && chmod +x /usr/bin/xtls && xtls && rm -f /usr/bin/xtls
...
wget -q -O /usr/bin/kumbang "https://raw.githubusercontent.com/Rerechan-Store/std/main/dll/kumbang.sh" && chmod +x /usr/bin/kumbang
...
wget -q -O /usr/bin/.ascii-home "https://raw.githubusercontent.com/Rerechan-Store/std/main/resources/ascii-home"
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
